    ...
    <>
      ...
      <div className="header-background-proposal pt-12 sm:pt-20 px-4 sm:px-0 flex flex-col justify-center items-center font-inter">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className='mt-8 text-12 sm:text-base font-light text-center'>Members can vote on proposals or delegate their vote to a third party. A minimum of 5 BUSD is required to submit proposals.</p>
        </div>
